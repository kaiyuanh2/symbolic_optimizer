...
int main() {
    ...
    // Load parameters
    ifstream param_file("param_ginac_toy.txt");
    vector<ex> param_vec;
    string line;
    ...
    try {
        ...
        cout << "test_preds[0]: " << test_preds[0] << endl;
        ...
        linearized_result = collect_common_factors(linearized_result);
        ...
        ofstream result_file("ginac_toy_result.txt");
        ...
        cout << "Full output saved to ginac_toy_output.txt" << endl;
        cout << "Expanded result saved to ginac_toy_result.txt" << endl;
        
    } catch (exception& e) {
        outfile << "Exception: " << e.what() << endl;
        cout << "Error occurred. See ginac_toy_output.txt for details." << endl;
    }
